    ...
    return(
        <div className="main px-[4vmin] py-[4vmin]">    
            ...
            <form className='flex justify-center gap-1' onSubmit={(e) => handleSubmit(e) }>         
                <input id="searchInput" className='input_string rounded-lg border w-96 px-5 py-2 focus:outline-none text-black' placeholder='Dish or major ingredients' required/>
