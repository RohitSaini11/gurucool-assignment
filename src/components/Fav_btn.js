...
//   }
    if(!isFavorite){
            return (
                <button onClick={toggleFavorite} className={isFavorite ? 'favorite absolute top-0 right-0 text-white' : 'notfavorite absolute top-0 right-0 px-4 py-1 text-white'}  >
                Add
                </button>
            );
       }
