...
const Card= (props) => {
    ...
    // }
    return(    
            <Link to={`details/${props.setasID}`} data-id={props.setasID} className="mt-5 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl md:min-w-[600px] hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
